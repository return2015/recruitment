...
public class AddCandidateController implements Serializable {
	...
	public String initialize() {
		try {
			...
			System.out.println("Ingreso a initialize de AddCandidateController");
			...
			if (sessionBean != null && sessionBean.getUser() != null && sessionBean.getUser().getId() > 0) {
				...
				List<RecruimentSource> recruimentSourcesDto = recruimentSourceService.findAll();
				recruimentSources = new ArrayList<SelectItem>();
				for (RecruimentSource recruimentSourceDto : recruimentSourcesDto) {
					SelectItem item = new SelectItem();
	...
	public void onChangeRecruitmentSource() {
		try {
			 ...
			 * "java:global/RecruitmentEAR/RecruitmentEJB/RecruimentSourceBean"
			 * + "!com.returnsoft.resource.service.RecruimentSourceInterface");*/
			  RecruimentSource recruimentSourcesDto =
